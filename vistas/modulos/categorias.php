          ...
          foreach ($categorias as $key => $value) {
            ...
            echo ' <tr>
                  ...
                  if($value["estado"] != 0){
                    ...
                    echo '<td><button class="btn btn-success btn-xs btnHabilitarCategoria" idCategoriaHabilitar="'.$value["id"].'" estadoCategoria="0">Habilitado</button></td>';

                  }else{

                    echo '<td><button class="btn btn-danger btn-xs btnHabilitarCategoria" idCategoriaHabilitar="'.$value["id"].'" estadoCategoria="1">Deshabilitado</button></td>';
