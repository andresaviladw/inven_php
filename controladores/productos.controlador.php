...
class ControladorProductos{
	...
	/*=============================================
	MOSTRAR PRODUCTOS ESTADO HABILITADO
	=============================================*/
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarDescripcion"]) &&	
			   preg_match('/^[0-9.]+$/', $_POST["editarPrecioCompra"])){
				...
				$datos = array(
								...
								"id_impuesto" => $_POST["editarImpuestos"],
	...
	static public function ctrTraerProductos($item, $valor){

		$tabla = "productos";
		

		$respuesta = ModeloProductos::mdlTraerProductos($tabla, $item, $valor);
