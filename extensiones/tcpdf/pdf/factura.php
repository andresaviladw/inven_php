...
//TRAEMOS LA INFORMACIÓN DEL EMISOR
...
$bloque1 = <<<EOF
	...
	<table>
	<tr>
	<td style="background-color:white; width:380px">
	<center><h2>$value[razon_social]</h2></center>
	</td>
	</tr>
		...
		<tr>
			...
			<td style="background-color:white; width:180px; text-align:center; color:red"><br><br>FACTURA N.<br>$detalle $valorVenta</td>
		...
		<td style="background-color:white; width:180px; text-align:center; color:red"><br><br>Autorizacion SRI: <br>$value[numero_autorizacion]</td>
		</tr>
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:120px">
				...
				Cedula / Ruc: $respuestaCliente[documento]
		...
		<td style="border: 1px solid #666; background-color:white; width:140px; text-align:right">
...
$precioTotal = number_format($item["precioSinIva"], 2);
